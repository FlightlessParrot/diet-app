<script setup>
import { ref } from 'vue';
import ApplicationLogo from '@/Components/ApplicationWhiteLogo.vue' ;
            ...
            <nav class="bg-brightGreen border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('specialist.index')" :active="route().current('specialist.index')">
                                    Znajdź specjalistę
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('specialist.index')" :active="route().current('specialist.index')">
                            Znajdź specjalistę
                        </ResponsiveNavLink>
                    </div>
